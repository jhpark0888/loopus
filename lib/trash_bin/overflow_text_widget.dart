...
//       TextSelection(
//         baseOffset: 0,
//         extentOffset: text.toPlainText().characters.length,
//       ),
//     );
//   }
// }
...
//           } else {
//             final fixedEllipsizedText = croppedText.characters
//                 .getRange(0, croppedText.length - _lineEnding.length);
...
//         .getRange(0, (text.length * requiredTextFraction).floor())
//         .string;
//   }
