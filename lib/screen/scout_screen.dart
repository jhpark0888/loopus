...
class ScoutScreen extends StatelessWidget {
  ...
  _updatePalettes(List<String> images) async {
  ...
  Widget companyRecImages(Contact contact) {
    ...
    return Container(
      color:
          colors.isNotEmpty ? colors[_currentIndex.value].color : Colors.white,
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text("당신에게 '집-중'하고 있는 추천 기업",
                style: kmainbold.copyWith(color: mainWhite)),
          ),
          SizedBox(height: 14),
          Padding(
            padding: const EdgeInsets.only(left: 20),
            child: Text(contact.slogan,
                style: kNavigationTitle.copyWith(color: mainWhite)),
          ),
          SizedBox(height: 14),
          Padding(
            padding: const EdgeInsets.only(left: 20),
            child: Text(contact.recommendation,
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
        ...
        child: Obx(
          () => _scontroller.screenState.value
              ? Scaffold(
                  appBar: AppBar(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: TabBar(
                            ...
                            tabs: List.from(_scontroller.careerField.values)
                                .map((field) {
                              if (field ==
                                  List.from(_scontroller.careerField.values)
                                      .last) {
