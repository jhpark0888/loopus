...
//           //   },
//           // ),
//           // Center(child: IconButton(onPressed: (){controller.channel.sink.add(jsonEncode({'message' : 'hi'}));}, icon: Text('보내기'))),
//           // StreamBuilder(stream: controller.channel.stream,builder: (context, snapshot) {
//           //   return Padding(
...
// //   var channel = IOWebSocketChannel.connect(Uri.parse('ws://192.168.35.172:8000/ws/chat/1/'),headers:  <String, String>{
