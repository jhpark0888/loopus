...
//       length: controller.careerField.length,
//       child: Scaffold(
...
//                   isScrollable: true,
//                   tabs:
//                       List.from(fieldList.values).map((e) => tabWidget(e)).toList(),
//                   onTap: (index) {
...
//                               .value
//                     });
//                     print(controller.currentFieldMap);
//                     print(controller.activeFieldsPost[
//                         controller.currentFieldMap.keys.first]);
//                   },
//                 )),
//           ),
//         ),
...
//                 children:
//                     List.generate(fieldList.length, (index) => tabViews(controller.careerFieldList[index])))),
//       ),
//     ));
//   }

//   Widget tabWidget(String field){
//     return Center(child: Tab(text: field));
//   }
...
//             () => ScrollNoneffectWidget(
//               child: Row(
//                   children: controller.activeFieldsPost[currentField.key.toString()] != null
//                       ? controller.activeFieldsPost[
...
//               primary: false,
//               shrinkWrap: true,
//               itemCount: HomeController.to.topTagList.length,
//               itemBuilder: (context, index) {
...
//                   children: controller.postUsageTrendNum.entries
//                       .map((e) => Column(
//                             mainAxisAlignment: MainAxisAlignment.end,
//                             children: [
//                               Text(controller.activeFieldsGraph[currentField.key.toString()]!['teptNumMap'] !=
//                                       null
//                                   ? controller.activeFieldsGraph[currentField.key.toString()]!['teptNumMap']![e.key]!
//                                       .toInt()
//                                       .toString()
//                                   : controller.teptNumMap[e.key]!
//                                       .toInt()
//                                       .toString()),
...
//                                   child: Container(
//                                     height: controller.activeFieldsGraph[currentField.key.toString()]!['postUsageTrendNum'] !=
//                                             null
//                                         ? controller.activeFieldsGraph[currentField.key.toString()]![
//                                                 'postUsageTrendNum']![e.key]!
//                                             .toDouble()
//                                         : controller.postUsageTrendNum[e.key],
//                                     width: 20,
